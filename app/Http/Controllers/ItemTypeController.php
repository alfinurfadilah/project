...
class ItemTypeController extends Controller
{
    ...
    {
        //
        $breadcumb = "Kategori Barang";

        $itemTypes = ItemType::when(request('search'), function($query){
            return $query->where('item_type_name','like','%'.request('search').'%');
        })
    ...
    {
        //
        $breadcumb = "Form Tambah Kategori Barang";
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            ITemType::create([
                'item_type_name' => $request->itemTypeName,
