                                        ...
                                        <div class="fv-row mb-10">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid"
                                                        name="namaBarang" value="{{ old('namaBarang') }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="uomId" aria-label="Pilih Satuan" data-control="select2"
                                                        ...
                                                        @foreach ($uom as $index => $value)
                                                            <option value="{{ $value->id }}">{{ $value->symbol }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="fv-row mb-5">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col mb-10-sm-12 mt-5"><img id="output" src=""
                                                            class="img-fluid"></div>
                                ...
                                <div class="row" id="templateBatchFormInput" style="display:none">
                                    <div class="row">
                                        <div class="col">
                                            <div class="fv-row mb-10">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label class="form-label required" for="hargaJual">Batch
                                                            ID</label>
                                                        <input class="form-control" type="text"
                                                            data-name="stock.batchId">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="fv-row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label class="form-label required" for="hargaJual">Jumlah
                                                            Stok</label>
                                                        <input class="form-control" type="text"
                                                            data-name="stock.qtyStock">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-10">
                                        <div class="col">
                                            <div class="form-group">
                                                <button type="button"
                                                    class="form-control btn btn-sm btn-danger me-3 btnRemove">
...
@section('onpage-js')
    ...
    <script>
        ...
        function getItemTypes(idCategory) {
            var divFormId = "divItem";
            var overlayId = "overlayDivItem";
            var route = '{{ route('item.getItemTypes', ':id') }}';
            route = route.replace(':id', idCategory);
