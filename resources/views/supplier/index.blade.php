...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <form action="{{ route('supplier.index') }}" method="get">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" name="search" class="form-control form-control-solid w-250px ps-15" placeholder="Cari Supplier" onblur="this.form.submit()">
                </div>
            </form>
            <!--end::Search-->
        </div>
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                <!--begin::Add customer-->
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_tambah_supplier">
                    Tambah Supplier
                </button>
                {{-- <a href="{{ route('supplier.create')}}" class="btn btn-primary">Tambah Customer</a> --}}
                <!--end::Add customer-->
            </div>
            <!--end::Toolbar-->
        </div>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('supplier.edit', $item->id) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->


                                            <!--begin::Delete button-->
                                            <form action="{{ route('supplier.delete', $item->id ) }}" method="POST" id="deleteCustomer{{ $item->id }}">
                                                @method('delete')
                                                @csrf
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_tambah_supplier">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('supplier.store') }}" method="POST" id="formTambahSupplier">
                        ...
                        <div class="fv-row mb-5">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-solid" name="phone" value="{{ old('phone') }}">
                        ...
                        <div class="fv-row mb-5">
                            <div class="col">
                                <div class="form-group">
                                    <label class="form-label" for="jumlahStock">No Handphone</label>
                                    <input type="number" class="form-control form-control-solid" name="mobilephone" value="{{ old('mobilephone') }}">
                                    @include('layouts.error', ['name' => 'phone'])
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btnTambahCustomer">Tambah Supplier</button>
                </div>
            </div>
        </div>
    </div>
