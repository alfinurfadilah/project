@extends('layouts.app')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('itemCategoryType.update') }}" method="POST" id="kt_create_pengeluaran">
            @csrf
            <input type="hidden" name="id" value="{{ $itemCategoryType->id }}">
                            ...
                            <div class="row mb-5">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid" name="name" value="{{ old('name', $itemCategoryType->name) }}" min="0">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" cols="30" rows="10" class="form-control form-control-solid">{{ old('description', $itemCategoryType->description) }}</textarea>
