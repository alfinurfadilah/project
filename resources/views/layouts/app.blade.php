    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            {{-- <div class="menu-item">
                                                <a class="menu-link {{ Route::is('itemCategoryType.index') ? 'active' : '' }}"
                                            href="{{ route('itemCategoryType.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                        ...
                                        {{-- <div class="menu-item">
                                               <a class="menu-link {{ Route::is('transactionCategory.index') ? 'active' : '' }}"
                                        href="{{ route('transactionCategory.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                ...
                <div class="menu-item py-3">
                    <a class="menu-link {{ Route::is('item.index') ? 'active' : '' }}" href="{{ route('item.index') }}"
                        title="Manajemen Barang" data-bs-toggle="tooltip" data-bs-trigger="hover"
                        data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-muted svg-icon-2x">
                ...
                {{-- <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start"
                                class="menu-item py-3 {{ Route::is('item.index') ? 'here' : '' }}
                {{ Route::is('itemHistory.index') ? 'here' : '' }}">
                <span class="menu-link" title="Manajemen Items" data-bs-toggle="tooltip" data-bs-trigger="hover"
                    data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start"
                ...
                <span class="menu-link" title="Manajemen Transaksi" data-bs-toggle="tooltip" data-bs-trigger="hover"
                    data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon">
            ...
            <div class="menu-item py-3">
                <a class="menu-link {{ Route::is('itemReceiving.index') ? 'active' : '' }}" href="{{ route('itemReceiving.index') }}"
                    title="Penerimaan Barang" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                ...
                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Route::is('reporting.laporanPenjualan') ? 'active' : '' }}"
                            href="{{ route('reporting.laporanPenjualan') }}"><span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Route::is('reporting.laporanTransaksiStock') ? 'active' : '' }}"
                            href="{{ route('reporting.laporanTransaksiStock') }}"><span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('datacalonpelanggan.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Data Calon Pelanggan</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="#">
